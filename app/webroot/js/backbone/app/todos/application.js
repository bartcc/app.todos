        ...
        clear: function() {
            ...
            this.destroy({
                success: function() {
                    ...
                    UnsavedTodos.removeUnsaved(that.get('id'));
                    // remove from view
                    that.view.remove();
...
//                window.UnsavedTodos = new UnsavedList;
    ...
    var sortableTodos = $('#todo-list').sortable();
    ...
    window.AppView = Backbone.View.extend({
        ...
        sortupdate: function(e, ui) {
            ...
            $(sortableTodos).children('li').each(function(index) {
                ...
                if(todo.get('order') != index) todo.save({order: index});
            });
        },
        ...
        markAllDone: function(ev) {
            Todos.each(function(todo) {
                todo.set({done: true}, {silent: false});
            })
            Todos.trigger('change:unsaved');
        ...
        markAllUndone: function(ev) {
            Todos.each(function(todo) {
                todo.set({done: false}, {silent: false});
            })
            Todos.trigger('change:unsaved');
