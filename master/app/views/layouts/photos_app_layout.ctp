...
<head>
    ...
    echo $this->Html->css('photos/application');
...
//    echo $this->Html->script('lib/underscore.debug');
    ...
    echo $this->Html->script('spine/app/photos/models/image');
    echo $this->Html->script('spine/app/photos/controllers/sidebar');
    echo $this->Html->script('spine/app/photos/controllers/images');
    echo $this->Html->script('spine/app/photos/application');
    ?>
