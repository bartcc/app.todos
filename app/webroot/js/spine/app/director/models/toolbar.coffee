  ...
  @dropdownGroups:
    ...
    group2:
      ...
      content:
        ...
        ,
          ...
          klass: 'optAlbum'
        ,
          name: -> if Gallery.record then ('Remove '+ '('+Gallery.selectionList().length+')') else 'Destroy (permanently)'
    ...
    group3:
      ...
      content:
        ...
        ,
          name: -> if Album.record then ('Remove '+ '('+Album.selectionList().length+')') else 'Destroy (permanently)'
